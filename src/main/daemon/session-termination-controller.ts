...
export class SessionTerminationController {
  ...
  kill(): void {
    ...
    // Why: an agent typed into a plain shell has no launchAgent marker, but its MCP/tool
    // children can still detach from the shell's process group. Snapshot every owned tree.
